    ...
    <div class="container mx-auto px-4 aos-init aos-animate xl:px-32" data-aos="fade-up">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="md:mt-20">
                <div class="grid grid-cols-1  gap-4 md:grid-cols-2 md:gap-6">
                    <div class="dark:bg-gray-800  p-6 shadow-xl" data-aos="fade-up"
                    >
        ...
        <div class="grid grid-cols-1 md:grid-cols-6 gap-8 feature-icons animate__animated animate__fadeIn mt-12"
            ...
            <div class="col-span-1 md:col-span-2 text-center animate__animated animate__fadeInRight"
                ...
                <img src="<?= base_url('static/img/features-3.png') ?>" class="mx-auto p-4 w-96" alt="">
            </div>

            <div class="col-span-1 md:col-span-4  flex content-center">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 self-center animate__animated animate__fadeIn">
                    <div class="icon-box">
