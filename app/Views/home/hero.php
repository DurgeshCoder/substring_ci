...
<section class="bg-white text-black  dark:text-blue-50 dark:bg-gray-900">
    <div class=" flex  flex-col md:flex-row lg:gap-x-40 xl:gap-x-32 justify-center w-full align-center   py-2  md:py-16 px-8   ">
        ...
        <div class="xl:mt-2  justify-center order-first md:order-last  flex aos-init "
             data-aos="zoom-in">
            <img data-aos="fade-up" class="w-2/3" src=" <?= base_url('static/img/banner-image1.svg') ?> "
