        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4 ">
            <div class="col-span-1 md:col-span-1 lg:col-span-1 mt-4 md:mt-0" >
                <div class=" box p-4 rounded-lg  text-center">
                    ...
                    <p class="mt-2">Eum ad dolor et. Autem aut fugiat debitis voluptatem consequuntur sit. Et veritatis id.</p>
                </div>
            </div>
            ...
            <div class="col-span-1 md:col-span-1 lg:col-span-1 mt-4 md:mt-0 ">
                <div class="box p-4  rounded-lg text-center">
                    ...
                    <p class="mt-2">Repudiandae amet nihil natus in distinctio suscipit id. Doloremque ducimus ea sit non.</p>
                </div>
            </div>
            ...
            <div class="col-span-1 md:col-span-1 lg:col-span-1 mt-4 md:mt-0" >
                <div class="box p-4   rounded-lg text-center">
                    ...
                    <p class="mt-2">Quam rem vitae est autem molestias explicabo debitis sint. Vero aliquid quidem commodi.</p>
                </div>
            </div>
</section>
<!--End section-->