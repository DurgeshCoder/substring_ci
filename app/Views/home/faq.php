<section id="faq" class="faq mt-16">
    <div class="container  mx-auto " data-aos="fade-up">
        <header class="section-header text-center">
            <h2 class="text-xl font-bold text-blue-600 dark:text-blue-50">F.A.Q</h2>
            <p class="text-blue-900 text-4xl font-bold my-3 dark:text-blue-50">Frequently Asked Questions</p>
        </header>
                    ...
                    <div
                        ...
                        <h2 class="mb-0" id="flush-headingOne">
                            <button
                                ...
                                1. What is Substring Technologies ?
                                <span
                    ...
                    <path
                        ...
                        <div
                            ...
                            <div class="px-5 py-4 dark:text-blue-50">
                                Substring Technologies is a private limited company that provide software solution as
                                well as software training.
                            </div>
                        </div>
                    </div>
                    <div
                  ...
                  <svg
                    ...
                    <path
                        ...
                        <div
                                ...
                                data-te-parent="#accordionFlushExample">
                            <div class="px-5 py-4 dark:text-blue-50">
                                We offer a range of services, including software development, web development, mobile
                                app development, quality assurance, UI/UX design, project management, and software
                                training.
                            </div>
                        </div>
                    </div>
                  ...
                  <svg
                    ...
                    <path
                        ...
                        <div
                                ...
                                data-te-parent="#accordionFlushExample">
                            <div class="px-5 py-4 dark:text-blue-50">
                                We have experience working with clients from various industries, such as finance,
                                healthcare, e-commerce, education, and more. Our team is adaptable and can cater to the
                  ...
                  <svg
                    ...
                    <path
                        ...
                        <div
                                ...
                                data-te-parent="#accordionFlushExample">
                            <div class="px-5 py-4 dark:text-blue-50">
                                We work with a wide array of technologies, including but not limited to Java, Python,
                                C#, JavaScript, Ruby, PHP, Swift, Android, iOS, Angular, React, Node.js, SQL, NoSQL, and
                                various frameworks and libraries associated with these technologies.
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <h2 class="mb-0" id="flush-headingFive">
                            <button
                                ...
                                5. Can you handle both small and large-scale projects?
                                <span
                                        class="-mr-1 ml-auto h-5 w-5 shrink-0 rotate-[-180deg] fill-[#336dec] transition-transform duration-200 ease-in-out group-[[data-te-collapse-collapsed]]:mr-0 group-[[data-te-collapse-collapsed]]:rotate-0 group-[[data-te-collapse-collapsed]]:fill-[#212529] motion-reduce:transition-none dark:fill-blue-300 dark:group-[[data-te-collapse-collapsed]]:fill-white">
                  <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                        ...
                        <div
                                ...
                                data-te-parent="#accordionFlushExample">
                            <div class="px-5 py-4 dark:text-blue-50">
                                Yes, we have experience working on projects of all sizes. Whether it's a small custom
                                development task or a large-scale enterprise solution, we have the expertise to handle
                                it effectively.. Our team conducts thorough testing, code reviews, and adheres to coding
                                standards to deliver high-quality software solutions.
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <h2 class="mb-0" id="flush-headingSix">
                            <button
                                ...
                                6. Do you offer training programs for software development?
                                <span
                                        class="-mr-1 ml-auto h-5 w-5 shrink-0 rotate-[-180deg] fill-[#336dec] transition-transform duration-200 ease-in-out group-[[data-te-collapse-collapsed]]:mr-0 group-[[data-te-collapse-collapsed]]:rotate-0 group-[[data-te-collapse-collapsed]]:fill-[#212529] motion-reduce:transition-none dark:fill-blue-300 dark:group-[[data-te-collapse-collapsed]]:fill-white">
                  <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                        ...
                        <div
                                ...
                                data-te-parent="#accordionFlushExample">
                            <div class="px-5 py-4 dark:text-blue-50">
                                Yes, we provide training programs tailored to individuals and organizations seeking to
                                enhance their software development skills. Our training covers various programming
                                languages, frameworks, and tools, and can be customized to meet specific requirements.
                            </div>
                        </div>
                    </div>
