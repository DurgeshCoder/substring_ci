...
<div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper1 h-[50vh]">
<div class="parallax-bg" style="background-image: url('<?= base_url('images/course_bg.jpg') ?>'); "  data-swiper-parallax="-23%"></div>

        
    <div class="swiper-wrapper text-center">
      <div class="swiper-slide grid grid-cols-1 md:grid-cols-2 -gap-4 lg:px-44 bg-black bg-opacity-20 transform transition duration-1000 hover:bg-opacity-40">
        <div class="grid place-items-center lg:-mt-32" data-swiper-parallax="-300">
            <div class="text-center px-8 md:text-left md:px-10 lg:mt-20 ">
              <h1 class="text-2xl md:text-4xl font-bold my-0 text-center animation" data-aos="fade-right" data-aos-duration="1000">Where Algorithms Meet Aspiration</h1>
              <p class="text-sm md:text-lg my-0 font-semibold mt-4 text-center animation" data-aos="fade-left" data-aos-duration="1000">Emphasizes the role of algorithms and problem-solving skills in fulfilling one's aspirations and goals.</p>
            </div>
          </div>
      ...
      <div class="swiper-slide grid grid-cols-1 md:grid-cols-2 -gap-4 lg:px-44 bg-black bg-opacity-20  transform transition duration-1000 hover:bg-opacity-40">
        <div class="grid place-items-center lg:-mt-32" data-swiper-parallax="-300">
            <div class="text-center px-8 md:text-left md:px-10 lg:mt-20">
              <h1 class="text-2xl md:text-4xl font-bold my-0 text-center animation" data-aos="fade-right" data-aos-duration="1000">Data-Driven Dreams, Code-Powered Reality</h1>
              <p class="text-sm md:text-lg my-0 font-semibold mt-4 text-center animation" data-aos="fade-left" data-aos-duration="1000">Conveys the idea that the world of data and code can transform dreams into a tangible and achievable reality.</p>
            </div>
          </div>
        <div class=" grid place-items-center">
      ...
      <div class="swiper-slide grid grid-cols-1 md:grid-cols-2 -gap-4 lg:px-44 bg-black bg-opacity-20  transform transition duration-1000 hover:bg-opacity-40">
        <div class="grid place-items-center lg:-mt-32" data-swiper-parallax="-300">
            <div class="text-center px-8 md:text-left md:px-10  lg:mt-20">
              <h1 class="text-2xl md:text-4xl font-bold my-0 text-center animation" data-aos="fade-right" data-aos-duration="1000">Smart Learning for Smart Minds.</h1>
              <p class="text-sm md:text-lg my-0 font-semibold mt-4 text-center animation" data-aos="fade-left" data-aos-duration="1000">Tailored education for fast learners, harnessing innate intelligence for advanced, stimulating, and innovative learning.</p>
            </div>
          </div>
        <div class=" grid place-items-center">
    ...
    <div class="container px-4 xl:px-16 mx-auto">
        ...
        <?php foreach($courses as $course): ?>
            <div
              ...
              <img class="rounded-t-lg hover:scale-[1.08] transition duration-700 ease-in-out h-64 w-full " src="<?= file_exists(FCPATH . "cover_images/" . $course['cover_image']) ? base_url("cover_images/" . $course['cover_image']) : base_url("cover_images/church.jpg") ?>" alt="Course Image" />
              ...
              <div class="p-6 transform duration-500 hover:-translate-y-2 cursor-pointer">
                ...
                <div class="grid place-items-center">
                  <a href="<?php echo base_url('course_view/'.$course['slug']) ?>">
