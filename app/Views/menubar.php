...
<nav class="bg-white border-b dark:border-0 shadow-lg dark:bg-gray-800 dark:text-blue-50 p-4 fixed-top ">
    <div class="container mx-auto flex items-center justify-between">
        ...
        <div class="hidden md:flex space-x-4 xl:space-x-8" id="desktopMenu">
            ...
            <a href="<?= base_url('/about') ?>" class="text-blue-900   dark:text-blue-50   font-bold">Services</a>
            <a href="<?= base_url('/services') ?>" class="text-blue-900   dark:text-blue-50   font-bold">Development</a>
            <a href="<?= base_url('/training') ?>" class="text-blue-900    dark:text-blue-50  font-bold">Training</a>
            <a href="<?= base_url('/') ?>" class="text-blue-900    dark:text-blue-50 font-bold">Gallery</a>
            <a href="<?= base_url('/about') ?>" class="text-blue-900    dark:text-blue-50  font-bold">AboutUs</a>
            <a href="<?= base_url('/services') ?>" class="text-blue-900    dark:text-blue-50  font-bold">ContactUs</a>
            <!--            <a href="-->
