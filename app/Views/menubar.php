...
<nav class="bg-white border-b dark:border-0 shadow-lg dark:bg-gray-800 dark:text-blue-50 p-4 fixed-top ">
    <div class="container mx-auto flex items-center justify-between">
     ...
     <!-- Mobile Menu Button and Dark Mode Button -->
            ...
            <!-- Mobile Menu Button -->
            <button type="button" class="md:hidden text-blue-900 hover:text-blue-500 focus:outline-none font-bold mt-2" id="mobileMenuButton">
                <svg class="block h-7 w-7 mb-2" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
        ...
        <div class="hidden md:flex space-x-4 xl:space-x-8" id="desktopMenu">
            ...
            <a href="<?= base_url('/trainings') ?>" class="text-blue-900   dark:text-blue-50   font-bold">Training</a>
 ...
 <!--            --><?php //= base_url('/training') ?><!--" class="text-blue-900    dark:text-blue-50  font-bold">Training</a>-->
            ...
            <button id="theme-toggle-1" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm">
                <svg id="theme-toggle-dark-icon-1" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
                <svg id="theme-toggle-light-icon-1" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" fill-rule="evenodd" clip-rule="evenodd"></path></svg>
            </button>
    ...
    <div class="md:hidden bg-white shadow-lg rounded-4 mt-6 hidden text-center p-2 min-vh-75 " id="mobileMenu">
        <div class="w-50 bg-white shadow-lg rounded-2 mt-6 text-center mx-auto">
            <a href="<?= base_url('/trainings')?>" class="block text-blue-900 py-2">Training</a>
        </div>
        <div class="w-50 bg-white shadow-lg rounded-2 mt-6 text-center mx-auto">
