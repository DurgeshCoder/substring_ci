...
<section id="add_topic" class=' mx-8 md:mx-16 md:ml-64 my-16 '>
 ...
 <h1 class="text-center py-4  text-4xl font-bold mb-4 text-blue-800 dark:text-gray-100">Edit Batch</h1>
 ...
 <?= validation_list_errors() ?>
  ...
  <form action="<?= base_url('admin/update_batch/'.$batch['batch_id']) ?>" method="post">
    ...
    <div class="container grid gap-2 w-full mx-auto px-8" id="input_fields" name="add_more">
          ...
          <div class="relative z-0 w-full group mb-5 grid " id="input_fields">
            <input type="text" value="<?= $batch['name']?>" name="batch_name" id="batch_name" class="block py-2.5 px-2.5 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=""/>
        ...
        <div class="relative z-0 w-full mb-10 group">
          <textarea name="short_description" value="" id="short_description" class="block py-2.5 px-2.5 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=""><?= $batch['short_description']?></textarea>
          <label for="short_description" class="peer-focus:font-medium absolute ml-2 text-lg text-gray-900 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-2 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-85 peer-focus:-translate-y-9">Description</label>
            ...
            <div class="relative z-0 w-full mb-10 group">
        <textarea name="long_description" cols="30" rows="8" id="long_description" value="" class="block py-2.5 px-2.5 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " ><?= $batch['long_description']?></textarea>
  ...
  <div class="grid md:grid-cols-2 gap-6">
    ...
    <div class="relative z-0 w-full  group ">
        ...
        <div class="relative mb-3" data-te-datepicker-init data-te-input-wrapper-init>
            ...
            <input  type="hidden" name='old_start_date' value='<?= $batch['start_date']?>'>
            <label
            for="floatingInput"
    ...
    <div class="relative z-0 w-full  group">
        <input type="text" name="timing" id="timing" value="<?= $batch['timing']?>" class="block py-2.5 px-2.5 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" >
    ...
    <div class="relative z-0 w-full  group mt-2">
     ...
     <div class="relative z-0 w-full  group">
        <input type="text" value="<?= $batch['number_of_admissons']?>" name="number_of_admissions" id="number_of_admissions" value="" class="block py-2.5 px-2.5 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" >
  ...
  <div class="relative z-0 w-full group mb-6 mt-4">
    <input type="text" name="instructor" id="instructor"  value="<?= $batch['instructor']?>" class="block py-2.5 px-2.5 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" >
...
<div class="relative z-0 w-full mb-10 group">
    <textarea name="message" id="message" value="" class="block py-2.5 px-2.5 w-full text-base text-gray-900 bg-transparent rounded-lg border-1 border-gray-400 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " ><?= $batch['message']?></textarea>
