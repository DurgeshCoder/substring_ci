 ...
 <div class='md:ml-16 bg-white p-2 md:p-6 rounded-lg shadow-lg dark:bg-gray-800'>
    ...
    <div class="w-full text-blue-700 ">
        <div class="p-4 flex flex-row items-center justify-between">
            <h1 class="ml-2 text-4xl font-semibold  focus:outline-none focus:shadow-outline dark:text-gray-100"> <?= $batch['name'] ?></h1>
        </div>
    </div>
    <!-- End of Navbar -->
        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2">
                ...
                <div class="bg-white p-3 border-t-4 border-blue-700 dark:bg-gray-700 dark:border-gray-900" >
                    ...
                    <h1 class="text-gray-900 font-bold text-xl leading-8 my-1 dark:text-gray-100">Batch ID: <?= $batch['batch_id'] ?></h1>
                    ...
                    <ul
                        ...
                        <li class="flex items-center py-3">
                            ...
                            <span class="ml-auto"><span
                                    class="bg-blue-700 py-1 px-2 rounded text-white text-sm dark:text-gray-100 dark:bg-gray-700"><?= $batch['admission_status'] ?></span></span>
                        </li>
                        <li class="flex items-center py-3 dark:text-gray-100">
                            <span>Number of Admissions</span>
                            <span class="ml-auto"><span
                                    class="bg-blue-700 py-1 px-2 rounded text-white text-sm dark:text-gray-100 dark:bg-gray-700"><?= $batch['number_of_admissons'] ?></span></span>
                        </li>
                        <li class="flex items-center py-3 dark:text-gray-100">
                            <span>Batch Status</span>
                            <span class="ml-auto"><span
                                    class="bg-blue-700 py-1 px-2 rounded text-white text-sm dark:text-gray-100 dark:bg-gray-700"><?= $batch['batch_status'] ?></span></span>
                        </li>
                        <li class="flex items-center py-3">
                            <span>Start Date</span>
                            <span class="ml-auto"><?= $batch['start_date'] ?></span>
                        </li>
                        <li class="flex items-center py-3">
                            <span>Timing</span>
                            <span class="ml-auto"><?= $batch['timing'] ?><span class="ml-2"></span></span>
                        </li>
                    </ul>
                </div>
                <!-- End of profile card -->
                ...
                <div class="bg-white p-3 shadow-sm rounded-sm dark:bg-gray-700"  >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                       ...
                       <div class="grid grid-cols-2 font-semibold gap-2">
                         ...
                         <div >
                              <h5 class="text-xl tracking-wide dark:text-gray-100"><?= $batch['instructor'] ?></h5>
                         </div>
...
<!-- Grid wrapper -->
                        ...
                        <div>
                            <div class="flex items-center space-x-2 text-2xl font-bold text-gray-900 leading-8 mb-3">
                                ...
                                <span class="tracking-wide dark:text-gray-100">Batch Message: </span>
                            </div>
                            <p class="text-gray-900 dark:text-gray-100">
                                <?= $batch['message'] ?>
                            </p>
    ...
    <div class=" font-semibold gap-2 grid grid-cols-1 grid-rows-1 md:grid-cols-12">
      <div class="md:col-start-1 md:col-span-12 bg-white p-3 shadow-sm rounded-sm dark:bg-gray-700 ">
